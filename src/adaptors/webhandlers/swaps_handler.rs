...
use crate::domain;
use domain::swaps::{
    SwapGroup, SwapResponse, SwapsInterval, SwapsIntervalResponse, SwapsMeta, SwapsQuery,
};


use crate::adaptors;
use adaptors::db::swaps_controller::fetch_data_for_intervals;
#[get("/history/swaps")]
async fn get_swaps_history(pool: Data<MySqlPool>, query: Query<SwapsQuery>) -> impl Responder {
